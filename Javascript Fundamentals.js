...
var thearray = [[3,4,5], [5,3,9], [4,2,1]];
 ...
 //"push" adds element ot end of array. "unshift" adds element to front of array
...
//In javascript the loal variables will take precidence over global ones.
...
//Instead of using switch statements we can do this
...
function updateRecords(id, prop, value){//if value set to blank we delete the property. (nothing in the string)
    ...
    }else {//if the value isnt blank and it isnt tracks then put it where theres its specified there's nothing.
